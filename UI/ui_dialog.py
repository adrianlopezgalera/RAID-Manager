...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.setMinimumSize(QSize(678, 266))
        Dialog.setMaximumSize(QSize(678, 266))
        self.widget = QWidget(Dialog)
        self.widget.setObjectName(u"widget")
        self.widget.setGeometry(QRect(40, 19, 631, 211))
        self.label = QLabel(self.widget)
        self.label.setObjectName(u"label")
        self.label.setGeometry(QRect(30, 80, 151, 21))
        ...
        self.current_attribute_label.setGeometry(QRect(30, 30, 121, 20))
        self.selector = QComboBox(self.widget)
        self.selector.setObjectName(u"selector")
        self.selector.setEnabled(False)
        self.selector.setGeometry(QRect(210, 80, 391, 23))
        self.selector_mode = QComboBox(self.widget)
        self.selector_mode.setObjectName(u"selector_mode")
        self.selector_mode.setEnabled(False)
        self.selector_mode.setGeometry(QRect(210, 110, 271, 23))
        self.label_mode = QLabel(self.widget)
        self.label_mode.setObjectName(u"label_mode")
        self.label_mode.setGeometry(QRect(30, 110, 151, 21))
