...
class Ui_RAID_Manager(object):
    def setupUi(self, RAID_Manager):
        ...
        RAID_Manager.setWindowModality(Qt.WindowModality.WindowModal)
        RAID_Manager.resize(720, 480)
        sizePolicy = QSizePolicy(QSizePolicy.Policy.Fixed, QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(RAID_Manager.sizePolicy().hasHeightForWidth())
        RAID_Manager.setSizePolicy(sizePolicy)
        RAID_Manager.setMinimumSize(QSize(720, 480))
        RAID_Manager.setMaximumSize(QSize(720, 480))
        font = QFont()
        ...
        self.actionExit = QAction(RAID_Manager)
        ...
        self.verticalFrame.setGeometry(QRect(30, 130, 651, 211))
